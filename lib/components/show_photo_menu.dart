...
void buildPhotoPickerMenu(BuildContext context,
    {required Function(File? pickedImage) onPick}) {
        ...
        CupertinoActionSheetAction(
            ...
            child: Row(
                ...
                children: [
                  ...
                  Icon(CupertinoIcons.camera, size: 26)
                ])),
        CupertinoActionSheetAction(
            onPressed: () async {
            ...
            child: Row(
              ...
              children: [
                ...
                Icon(CupertinoIcons.photo_fill_on_rectangle_fill, size: 26)
              ],
            )),
        CupertinoActionSheetAction(
