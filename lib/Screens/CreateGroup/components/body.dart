...
class _BodyState extends State<Body> {
  ...
  createGroup() {
    ...
    subjects.forEach((element) {
      subject.add(element.name);
    });
    Group newGroup = new Group(groupName, selectedImage!.path, DateTime.now(),
        subject, int.parse(quizSize), 1, 1);
    globals.itemsData.add(newGroup);
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => UserViewScreen(newGroup)));
  }
